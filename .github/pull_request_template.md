...
<!-- Brief description of what the skill teaches AI assistants -->

**When should this skill be used?**

<!-- List 2-3 key scenarios where this skill is valuable -->
...
<!-- Include screenshots, terminal output, or examples of the skill in action -->
...
- [ ] New domain-specific terms added to `cspell.config.json`
